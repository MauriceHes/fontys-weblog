...
public class UserServiceEJB implements IUserService
{
    ...
    public User findUserByName(String name) {
        System.out.println(getDateTime() + " - findEJBUserByName: " + name);
    ...
    public void initUsers() {
        ...
        addTweetToUser(u1.getName(), "#hallo @hans vet cool");
        addTweetToUser(u1.getName(), "#hallo #again #you vet");
        addTweetToUser(u1.getName(), "#hallo #where are #you cool");
    }
